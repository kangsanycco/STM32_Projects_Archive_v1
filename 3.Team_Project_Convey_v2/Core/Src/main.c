...
int main(void)
{
  ...
  Task_SystemHandle = osThreadNew(StartTask02, NULL, &Task_System_attributes);

  /* creation of Task_FSM */
  Task_FSMHandle = osThreadNew(StartTask03, NULL, &Task_FSM_attributes);
