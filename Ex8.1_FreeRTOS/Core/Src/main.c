...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of LD1Task */
  LD1TaskHandle = osThreadNew(StartDefaultTask1, NULL, &LD1Task_attributes);

  /* creation of LD2Task */
  LD2TaskHandle = osThreadNew(StartTask02, NULL, &LD2Task_attributes);

  /* creation of LD3Task */
  LD3TaskHandle = osThreadNew(StartTask03, NULL, &LD3Task_attributes);
...
/* USER CODE BEGIN Header_StartDefaultTask1 */
/**
  * @brief  Function implementing the LD1Task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartDefaultTask1 */
void StartDefaultTask1(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
