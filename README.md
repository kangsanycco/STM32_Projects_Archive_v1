...
STM32CubeIDE 기반으로 구현한 임베디드 코드입니다.  
단순 main.c에 모든 로직을 넣지 않고, **추상화 계층 구조**를 도입하여 유지보수성과 확장성을 높였습니다.

### 📂 Directory Hierarchy
2. Team_Project_Convey_v4_ver.446<br>
└── Core<br>
&nbsp;&nbsp;&nbsp;&nbsp;├── **Src**<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── `main.c`: 초기화 + FreeRTOS 커널 시작<br>
&nbsp;&nbsp;&nbsp;&nbsp;├── **App** (Application Layer)<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── `app_fsm.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;├── **Task** (Scheduling Layer)<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── `task_system.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;├── **Bsp** (Board Support Package)<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── `bsp_sensor.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── `bsp_servo.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── `bsp_robot.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;├── **Common** (공유 라이브러리 & 프로토콜)<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── `config.h`<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── `system_state.h`<br>
&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── `function.h`<br>
&nbsp;&nbsp;&nbsp;&nbsp;└── **Driver** (Driver Layer)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├── `drv_exti.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├── `drv_uart.c`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└── `drv_i2c.c`
...
- **HW**: 멀티미터, 데이터시트 분석, 전원 안정화 (커패시터·저항 배치)
