...
![폴더 구조 이미지](assets/folder_tree.png)  
*(위 이미지를 GitHub에 업로드 후 경로 맞춰주세요. Tree 명령어 캡처나 draw.io로 그린 다이어그램 추천)*

<details>
<summary>📂 Practice - 연습 프로젝트</summary>

팀 프로젝트 적응을 위한 발판으로 제작한 연습 코드 모음입니다

- STM32CubeIDE 활용  
- GPIO, EXTI, UART, DMA, ADC, TIMER, PWM, FreeRTOS 등 기본 기능 실습  
- 미디어·서적·AI 자료 참고하여 구현
...
- **Bsp** (Board Support Package) - 신호를 장치 단위로 변환  
  ...
  - `bsp_stepper.c`: TB6600 드라이버 펄스·방향 제어
